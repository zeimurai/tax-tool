"""
Django settings for taxtoolbackend project.
...
SECRET_KEY = 'django-insecure-dk0#d9^8+yr8g8z&f6-a)3f$&$%2su)eate(6q1#elfw7eo_=a'
...
ROOT_URLCONF = 'taxtoolbackend.urls'
...
WSGI_APPLICATION = 'taxtoolbackend.wsgi.application'
